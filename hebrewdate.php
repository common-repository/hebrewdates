...
function GetHebrewDateString($content, $format="", $originalRequest=null) {
	...
	list ($hebrewMonth, $hebrewDay, $hebrewYear) = explode ('/', jdtojewish(gregoriantojd($month, $day, $year)));
	list ($endHebrewMonth, $endHebrewDay, $endHebrewYear) = explode ('/', jdtojewish(gregoriantojd($endMonth, $endDay, $year)));
